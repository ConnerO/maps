...
function addCoords(data) {
	...
	data.forEach(function(element, index) {
		if (!element.longitude || !element.latitude) {
			...
			promises.push(formatCoords(index, element.crime_type, element.time, element.address+", Austin, Texas", parseFloat(element.latitude), parseFloat(element.longitude), element.date, element.incident_report_number));
		}
